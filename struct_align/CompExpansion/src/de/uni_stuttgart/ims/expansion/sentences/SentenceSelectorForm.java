...
/**
 * Index-based sentence selector, key is word form.
 * 
 * @author kesslewd
 *
 */
public class SentenceSelectorForm extends SentenceSelectorIndexBased {
    ...
    * This corresponds to all words with the same word form.
    * 
   ...
   public List<Word> getPredicatesFromUnlabeledSentence (SRLSentence labeledSentence, Word labeledPredicate, SRLSentence unlabeledSentence) {     
      return StringWordMapping.identifyOneWordAll(unlabeledSentence, labeledPredicate.getForm(), false, false);
   }
   

   @Override
   public String getName() {
      return "SentSelIndexBased(Form)";
   }
