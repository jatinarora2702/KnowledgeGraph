...
def isValidBgram(pos1, pos2):
    if "NN" in pos1 and "NN" in pos2:
        return True
    elif "JJ" in pos1 and "NN" in pos2:
        return True
    else:
        return False
...
fr = codecs.open(store.DATA_PATH + "Jindal-Liu/labeledSentences.txt", "r", 'cp1252')
f = 0
sent = []
act = 0
k = 0
                        ...
                        if isValid(posOftoken):  # begin your thing
                            if (checkIfTokenPartOfAspect(token, asplist)):
                                ...
                                for features in flist:
                                    print("no," + features[0] + "," + features[1] + "," + features[2] + "," + features[
                                        3] + "," + features[4] + "," + features[5] + "," + features[6] + "," + features[
                                              7])
                                    nocases += 1
                                ...
                                # print comma separated
                                for features in flist:
                                    print("yes," + features[0] + "," + features[1] + "," + features[2] + "," + features[
                                        3] + "," + features[4] + "," + features[5] + "," + features[6] + "," + features[
                                              7])
                                    yescases += 1
                ...
                for token in biagramlist:
                    ...
                    if isValidBgram(pos1, pos2):
                        if (checkIfAspect(token, asplist)):
                            ...
                            for features in flist:
                                print("yes," + features[0] + "," + features[1] + "," + features[2] + "," + features[
                                    3] + "," + features[4] + "," + features[5] + "," + features[6] + "," + features[7])
                                yescases += 1
